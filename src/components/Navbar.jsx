    ...
    <nav
      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        <Link to='/'
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Mohit &nbsp;<span className='sm:block hidden'> Kumar</span></p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          <div className={`${!toggle ? "hidden" : "flex"} p-6 black-gradient absolute top-20  right-0 mx-4 my-2 min-w-[140px] rounded-xl z-10`}>
            <ul className='list-hidden flex justify-end items-start flex-col gap-4'>
              {
                navLinks.map((link) => (
                  <li 
                    key={link.id} 
